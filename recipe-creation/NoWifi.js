		...
		<View style={styles.container}>
            ...
            <View style={[styles.container, {justifyContent: 'space-around'}]}>
                ...
                <View style={styles.button}>
                    <ButtonCustom style={{width: 150}} callback={() => navigation.navigate(nextScreen, {cellular: true, data: data})} text="Continuar" />
                    <ButtonCustom style={{width: 150}} callback={() => navigation.navigate('WelcomeScreen')} text="Descartar" />
                </View>
            </View>
		</View>
	);
